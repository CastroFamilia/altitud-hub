with open('src/app/acm/ACMClient.jsx', 'r') as f:
    content = f.read()
...
state_old = "  const [selectedPropertyId, setSelectedPropertyId] = useState('');"
state_new = """  const [selectedPropertyId, setSelectedPropertyId] = useState('');
...
with open('src/app/acm/ACMClient.jsx', 'w') as f:
    f.write(content)
