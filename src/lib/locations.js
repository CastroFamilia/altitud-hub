...
export function getACMFlatIndex() {
...
export function searchACMLocations(query, limit = 12) {
...
// ==========================================
export const ACM_DISTRICT_COORDS = {
    // Pérez Zeledón
...
export const ACM_BARRIO_COORDS = {
...
export function getLocationCoords(canton, district, barrio) {
