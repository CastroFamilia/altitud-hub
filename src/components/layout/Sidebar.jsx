...
function SidebarContent() {
  ...
  const adminConfigItems = [
    ...
    { href: '/oficina?tab=syndication', icon: '📋', label: lang === 'en' ? 'Portal Syndication' : 'Sindicación Portales', isCustomActive: pathname === '/oficina' && activeTab === 'syndication' },
    { href: '/oficina?tab=reconnect-sync', icon: '🔄', label: 'ReConnect Sync', isCustomActive: pathname === '/oficina' && activeTab === 'reconnect-sync' },
    { href: '/oficina?tab=integraciones', icon: '🔌', label: lang === 'en' ? 'API Integrations' : 'Cargar APIs', isCustomActive: pathname === '/oficina' && activeTab === 'integraciones' },
  ...
  const crmToolsItems = [
    ...
    { href: lang === 'en' ? '/search' : '/busqueda', isCustomActive: pathname.startsWith('/busqueda') || pathname.startsWith('/search'), icon: <svg className="w-5 h-5 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>, label: t('nav_search') || 'BÚSQUEDA' },
    { 
      href: '/olimpia', 
      label: 'OLYMPIA AI', 
      badge: 'AI', 
