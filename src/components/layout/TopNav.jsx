  ...
  return (
    <header className="h-16 md:h-20 glass-panel border-b border-gray-200 dark:border-dark-border flex items-center justify-between px-4 md:px-8 z-10 transition-colors shrink-0 shadow-xs dark:shadow-none">
      ...
      <div className="flex items-center space-x-2 md:space-x-3 shrink-0">
        ...
        {/* Notifications */}
        <button className="relative w-8 h-8 md:w-9 md:h-9 rounded-full bg-white dark:bg-dark-bg border border-gray-300 dark:border-dark-border flex items-center justify-center text-gray-600 dark:text-gray-400 hover:text-brand-500 dark:hover:text-brand-400 transition-colors shadow-sm" title="ALTITUD AI Mentor">
