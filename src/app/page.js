...
export default function Dashboard() {
  ...
  const handleNewACM = () => {
    window.open(ACM_REMAX_URL, '_blank');
  };
          ...
          <div className="fade-in space-y-6">
            <div className="flex justify-between items-end px-1">
              ...
              <button
                ...
                className="bg-nexus-blue hover:bg-blue-700 text-white px-8 py-4 rounded-2xl text-[11px] font-black uppercase tracking-widest shadow-xl shadow-blue-500/20 transition-all transform hover:scale-105 active:scale-95"
              >
                {t('dash_btn_new_acm')}
              </button>
            </div>
