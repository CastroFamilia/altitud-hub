...
export default function OficinaEstadoCuenta() {
  ...
  // By default, if not broker, redirect (BYPASSED for preview as in other files)
  /*
  useEffect(() => {
  ...
  */
  ...
  return (
    <>
      <TopNav title="Finanzas Oficina" subtitle="Gestión de Estados de Cuenta y Rentabilidad" />
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden p-4 md:p-8 relative z-0 bg-slate-50 dark:bg-dark-bg">
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-slate-800 rounded-3xl p-6 shadow-xl border border-slate-200 dark:border-slate-700 col-span-1 md:col-span-2 flex flex-col justify-center relative overflow-hidden">
            ...
            <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-6 shadow-xl border border-slate-800 relative flex flex-col justify-center">
          ...
          <div className="w-full lg:w-2/3 space-y-6">
            {!selectedAgentId ? (
              <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-xl border border-slate-200 dark:border-slate-700 p-12 text-center h-full flex flex-col items-center justify-center">
              ...
              <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-xl border border-slate-200 dark:border-slate-700 overflow-hidden flex flex-col h-full">
                {/* Header Profile */}
